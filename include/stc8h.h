...
#define     DBLNTH                  (*(unsigned char volatile __xdata *)0xfb82)
#define     COMLNTHL                (*(unsigned char volatile __xdata *)0xdb83)
#define     COMLNTHM                (*(unsigned char volatile __xdata *)0xfb84)
#define     COMLNTHH                (*(unsigned char volatile __xdata *)0xfb85)
#define     BLINKFRPS               (*(unsigned char volatile __xdata *)0xfb86)
#define     LCDCR                   (*(unsigned char volatile __xdata *)0xfb87)
#define     COM_ON_A                (*(unsigned char volatile __xdata *)0xfb88)
#define     COM_ON_B                (*(unsigned char volatile __xdata *)0xfb89)
#define     SEG_ON_A                (*(unsigned char volatile __xdata *)0xfb8a)
#define     SEG_ON_B                (*(unsigned char volatile __xdata *)0xfb8b)
#define     SEG_ON_C                (*(unsigned char volatile __xdata *)0xfb8c)
#define     SEG_ON_D                (*(unsigned char volatile __xdata *)0xfb8d)
#define     SEG_ON_E                (*(unsigned char volatile __xdata *)0xfb8e)
